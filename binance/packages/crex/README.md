...
## 回测
示例 [@backtest](https://github.com/koinotice/redox/packages/crex/blob/master/examples/backtest/main.go)

## 实盘
示例 [@live trading](https://github.com/koinotice/redox/packages/crex/blob/master/examples/live/main.go)
